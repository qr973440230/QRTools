package com.qr.core.adapter.base.callback;
...
import com.qr.core.adapter.base.BaseItemDraggableAdapter;
import com.qr.core.adapter.base.BaseQuickAdapter;
...
//    private static final String TAG = ItemDragAndSwipeCallback.class.getSimpleName();
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (actionState == ItemTouchHelper.ACTION_STATE_DRAG
            ...
            viewHolder.itemView.setTag(R.id._BaseQuickAdapter_dragging_support, true);
        } else if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE
                && !isViewCreateByAdapter(viewHolder)) {
            mAdapter.onItemSwipeStart(viewHolder);
            viewHolder.itemView.setTag(R.id._BaseQuickAdapter_swiping_support, true);
        }
    ...
    public void clearView(@NonNull RecyclerView recyclerView,@NonNull RecyclerView.ViewHolder viewHolder) {
        ...
        if (viewHolder.itemView.getTag(R.id._BaseQuickAdapter_dragging_support) != null
                && (Boolean) viewHolder.itemView.getTag(R.id._BaseQuickAdapter_dragging_support)) {
            mAdapter.onItemDragEnd(viewHolder);
            viewHolder.itemView.setTag(R.id._BaseQuickAdapter_dragging_support, false);
        }
        if (viewHolder.itemView.getTag(R.id._BaseQuickAdapter_swiping_support) != null
                && (Boolean) viewHolder.itemView.getTag(R.id._BaseQuickAdapter_swiping_support)) {
            mAdapter.onItemSwipeClear(viewHolder);
            viewHolder.itemView.setTag(R.id._BaseQuickAdapter_swiping_support, false);
        }
    }
